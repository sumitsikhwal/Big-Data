...
val calllog = sc.textFile("/vxp141230/tip.txt")
...
sc.parallelize(list,1).saveAsTextFile("/vxp141230/ProjectOutput/latlong.txt")
...
sc.parallelize(list1,1).saveAsTextFile("/vxp141230/ProjectOutput/latlong1.txt")